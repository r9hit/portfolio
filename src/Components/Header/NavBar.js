...
const NavBar = (e) => {
  ...
  return (
    ...
    <div className="icons">
      <a href="https://www.instagram.com/_r9hit/"><i class="fa-brands fa-instagram"></i></a>
      <a href="https://github.com/r9hit"><i class="fa-brands fa-github"></i></a>
      <a href="https://www.linkedin.com/in/r9hit/"><i class="fa-brands fa-linkedin"></i></a>
    </div>
    ...
    <ul class="menu">
      <li><a href="https://www.instagram.com/_r9hit/">Instagram</a></li>
      <li><a href="https://github.com/r9hit">Github</a></li>
      <li><a href="https://www.linkedin.com/in/r9hit/">Linkedin</a></li>
      <li>
      ...
      <li>
        <a href="mailto:choudharyrohit313131@gmail.com">Email</a>
      </li>
    </ul>
